...
// Используем переопределенный $selected_city_booking_service вместо оригинального $selected_city
...
$args = array(
    ...
    'tax_query'      => array(
        ...
        array(
            'taxonomy' => 'category',
            'field'    => 'slug',
            'terms'    => $selected_city_booking_service, // Используем переопределенный $selected_city_booking_service
        ),
        array(
            'taxonomy' => 'category',
            'field'    => 'slug',
