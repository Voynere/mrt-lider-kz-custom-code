...
Маркетинговые цифры на главной (2026-08-14): **13** лет опыта, **58** филиалов сети.

Льготный прайс (как на RU) для стандартных городов — см. `chunks/15-kz-concessional-pricing.md` и `chunks/14-session-2026-08-14.md`.
